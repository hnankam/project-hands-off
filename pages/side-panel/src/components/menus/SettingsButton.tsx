/**
 * Shared Settings Button Component
...
export const SettingsButton: React.FC<SettingsButtonProps> = ({ isLight, theme, onOpenSettings }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className={cn(
            'absolute bottom-full right-0 mb-1 w-64 rounded-md border shadow-lg',
            isLight
