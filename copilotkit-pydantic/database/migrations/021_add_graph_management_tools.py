"""
Migration: Add Graph Management Tools to Database

This migration adds the new graph management tools to the database:
- update_graph_status
- rename_graph
- list_graphs
- delete_graph

Run this migration to ensure the tools are registered and available for agents.

Usage:
    python database/migrations/021_add_graph_management_tools.py
...
GRAPH_TOOLS = [
    {
        "tool_key": "update_graph_status",
        "tool_name": "Update Graph Status",
        "tool_type": "backend",
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "status": {
                    "type": "string",
                    "enum": ["active", "paused", "completed", "cancelled", "waiting"],
                    "description": "New status for the graph"
                }
            },
            "required": ["graph_identifier", "status"]
        },
    ...
    {
        "tool_key": "rename_graph",
        "tool_name": "Rename Graph",
        "tool_type": "backend",
        ...
        "parameters": {
            ...
            "properties": {
                "graph_identifier": {
                    "type": "string",
                    "description": "Current graph name or ID"
                },
                "new_name": {
                    "type": "string",
            ...
            "required": ["graph_identifier", "new_name"]
        },
        "category": "graph_management"
        },
        "enabled": True,
    ...
    {
        "tool_key": "list_graphs",
        "tool_name": "List Graphs",
        "tool_type": "backend",
    ...
    {
        "tool_key": "delete_graph",
        "tool_name": "Delete Graph",
        "tool_type": "backend",
        ...
        "parameters": {
            ...
            "properties": {
                "graph_identifier": {
                    "type": "string",
                    "description": "Graph name or ID to delete"
                }
            },
...
def main():
    """Run the migration to add graph management tools"""
    logger.info("=" * 70)
    logger.info("MIGRATION 021: Add Graph Management Tools")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.info(f"   📝 Total: {len(GRAPH_TOOLS)} tools")
                logger.info("=" * 70)
...
def rollback():
    """Rollback the migration by removing graph management tools"""
    logger.info("=" * 70)
    logger.info("ROLLBACK 021: Remove Graph Management Tools")
    logger.info("=" * 70)
