...
# =============================================================================
# Confluence MCP Server - Build and Run Script
# =============================================================================
...
echo -e "${BLUE}============================================${NC}"
echo -e "${BLUE}🔨 Confluence MCP Server - Build & Deploy${NC}"
echo -e "${BLUE}============================================${NC}"
echo ""
...
if docker ps --filter name="$CONTAINER_NAME" --filter status=running | grep -q "$CONTAINER_NAME"; then
    echo -e "${GREEN}✅ Confluence MCP Server is running!${NC}"
    echo ""
