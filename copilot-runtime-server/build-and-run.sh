...
# =============================================================================
# CopilotKit Runtime Server - Build and Run Script
# =============================================================================
#
...
IMAGE_NAME="copilot-runtime-server"
PORT=3001
ENV_FILE=".env"
...
echo -e "${BLUE}╔════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  CopilotKit Runtime Server - Build and Run Script             ║${NC}"
...
# Get PYDANTIC_SERVICE_URL from .env or use default
PYDANTIC_URL=$(grep "^PYDANTIC_SERVICE_URL=" ${ENV_FILE} | cut -d '=' -f2 || echo "http://host.docker.internal:8001")
...
if [ "$TARGET" == "development" ]; then
    ...
    docker run -d \
        ...
        -e DEBUG=true \
        -e PYDANTIC_SERVICE_URL=${PYDANTIC_URL} \
...
echo -e "${GREEN}Python Backend:${NC} ${PYDANTIC_URL}"
echo ""
echo -e "${BLUE}Available endpoints:${NC}"
echo -e "  • Health:       ${GREEN}http://localhost:${PORT}/health${NC}"
echo -e "  • CopilotKit:   ${GREEN}http://localhost:${PORT}/api/copilotkit${NC}"
echo -e "  • Auth:         ${GREEN}http://localhost:${PORT}/api/auth/*${NC}"
echo -e "  • Admin:        ${GREEN}http://localhost:${PORT}/api/admin/*${NC}"
echo ""
