...
router.get('/:invitationId', async (req, res) => {
  try {
    ...
    // Use Better Auth's getInvitation API with proper headers
    ...
    console.log('🔍 Better Auth getInvitation result:', JSON.stringify(result, null, 2));
    ...
    const rawInvitation = result.data || result;
    ...
    const invitation = {
      ...
      organization: {
        ...
        logo: rawInvitation.organizationLogo || null,
      },
      inviter: {
        email: rawInvitation.inviterEmail,
        name: rawInvitation.inviterName || null,
      },
